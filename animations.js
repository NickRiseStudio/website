...
(function () {
  ...
  /* ─── ПАРАЛЛАКС ФОНА ГЛАВНОГО ЭКРАНА (hero-bg.webp) ───────────────────
     ...
     перечитываем: секция при прокрутке высоту не меняет (её держат
     height/min-height/max-height из style.css), а живой замер в каждом кадре
     — лишняя переклейка раскладки.
     ...
     безвредно: на телефоне его режет overflow-y: clip самой секции, на
     компьютере он и так дотянут на 80px до #player (см. style.css).
